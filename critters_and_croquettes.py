...
walking_animal1 = Donkey("walking_animal1", "mammal", "food", 11)
walking_animal2 = Goat("walking_animal2", "mammal", "food", 12)
walking_animal3 = Llama("walking_animal3", "mammal", "food", 13)
walking_animal4 = Rabbit("walking_animal4", "mammal", "food", 14)
walking_animal5 = Sheep("walking_animal5", "mammal", "food", 15 )
